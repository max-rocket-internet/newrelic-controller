...
class AlertsPolicies(Resource):
    ...
    def create(self, name, incident_preference):
        ...
        incident_preference must be one of PER_POLICY, PER_CONDITION, PER_CONDITION_AND_TARGET
        '''
        data = {
            'policy': {
    ...
    def list(
        ...
        ::

            {
                ...
                "pages": {
                    "last": {
                        "url": "https://api.newrelic.com/v2/alerts_policies.json?page=2",
                        "rel": "last"
                    },
                    "next": {
                        "url": "https://api.newrelic.com/v2/alerts_policies.json?page=2",
